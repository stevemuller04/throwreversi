...
class RgbwaFlashTask : public Task
{
	...
	public:
		 ...
		 * @param layer - The layer at which the color shall be set. See LedMatrixOutputManager::setColor() for more details.
		 ...
		 */
		RgbwaFlashTask(LedMatrixOutputManager &output, coord_t x, coord_t y, uint8_t layer, rgbwa initial_color, rgbwa final_color, mtime_t interval, uint8_t repetitions);
